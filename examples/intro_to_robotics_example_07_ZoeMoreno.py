...
def wiggle():
    speed = 50
    _, joint_angle = arm.get_servo_angle()
    _, pose_tool = arm.get_position()
    angles_6 = [3 + joint_angle[5], 0 + joint_angle[5], -3 + joint_angle[5], 0 + joint_angle[5], 3 + joint_angle[5], 0 + joint_angle[5], -3 + joint_angle[5], 0 + joint_angle[5], 3 + joint_angle[5], 0 + joint_angle[5]] 
    angles_5 = [3 + joint_angle[4], 0 + joint_angle[4], -3 + joint_angle[4], 0 + joint_angle[4], 3 + joint_angle[4], 0 + joint_angle[4], -3 + joint_angle[4], 0 + joint_angle[4], 3 + joint_angle[4], 0 + joint_angle[4]] 
    
    for angle_5, angle_6 in zip (angles_5,angles_6):
        arm.set_servo_angle(servo_id=5, angle=angle_5, speed=speed, wait=True) 
        arm.set_servo_angle(servo_id=6, angle=angle_6, speed=speed, wait=True) 
...
# arm.set_pause_time(2)
# arm.set_position(x= 214, y=-313, z=140, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(5)
# arm.set_position(x=163, y=-283, z=199, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(2)
# arm.set_position(x=163, y=-283, z=140, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(5)
# arm.set_position(x=163, y=-341, z=199, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(2)
# arm.set_position(x=163, y=-341, z=140, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(5)
# arm.set_position(x=163, y=-341, z=210, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
# arm.set_pause_time(5)
