...
# send the arm to the pose (x,y,z,roll,pitch,yaw) with speed of 50 mm/s
arm.set_position(x=90, y=-235, z=30, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
...
# send the arm to the pose (x,y,z,roll,pitch,yaw) with speed of 50 mm/s
arm.set_position(x=95, y=-250, z=65, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
...
# send the arm to the pose (x(mm),y(mm),z(mm),roll(deg),pitch(deg),yaw(deg)) with speed of 50 mm/s
arm.set_position(x=95, y=-250, z=80, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_pause_time(5)
...
# send the arm to the pose (x,y,z,roll,pitch,yaw) with speed of 50 mm/s
arm.set_position(x=95, y=-250, z=95, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
...
# send the arm to the pose (x(mm),y(mm),z(mm),roll(deg),pitch(deg),yaw(deg)) with speed of 50 mm/s
arm.set_position(x=95, y=-250, z=100, roll=-180, pitch=0, yaw=0, speed=50, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_pause_time(5)
